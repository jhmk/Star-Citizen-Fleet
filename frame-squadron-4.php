...
$feed = 'https://docs.google.com/spreadsheets/d/...LINK ID TO Squadron 4 FLEET.../export?format=csv';
...
*/
{
	...
	*/
	...
	echo '<br/> <a href="https://docs.google.com/spreadsheets/d/...LINK ID TO Squadron 4 FLEET.../pubhtml?gid=0&single=true" style="color:#c1eefe">Squadron 4 List</a>';
	echo '</div>';
	echo '</li>';
	$groupArray = array();
